...
function getServiceIdFromPath() {
  const match = window.location.pathname.match(/^\/services\/(\d+)$/);
...
function ServiceDetailsView({ services }) {
    ...
    return (
      <section className="content-section">
        <SectionHeader
          ...
          text="Checking the current service request."
          icon={Sparkles}
        />
        <LoadingState label="service details" />
      </section>
    );
  }
    ...
    return (
      <section className="content-section">
        <SectionHeader
          ...
          text="The service request could not be loaded."
          icon={Sparkles}
        />
    ...
    return (
      <section className="content-section">
        <SectionHeader
          eyebrow="Service details"
          title="Service unavailable"
          text="The requested service list is empty."
          icon={Sparkles}
        />
        <EmptyState title="No services found" message="Try another service reference." />
      </section>
    );
  }
    ...
    return (
      <section className="content-section">
        <SectionHeader
          ...
          text="The selected service identifier is not present in the mock data."
          icon={Sparkles}
        />
        <ErrorState message={`Service ${serviceId} was not found in services.json`} />
      </section>
    );
  }
    ...
    <section className="content-section">
      ...
      <div className="service-detail-panel">
        ...
        <div className="service-detail-copy">
          <span className="service-detail-label">Service #{service.id}</span>
          <h3>{service.title}</h3>
...
function App() {
  ...
  return (
    <div className="page-shell">
      ...
      <main>
        <ServiceDetailsView services={services} />
        ...
        <section id="services" className="content-section">
          ...
          {services.loading ? (
            ...
            <EmptyState title="No services found" message="There are no services available right now." />
          ) : (
